...
//console.log(shopping.slice(0,17)+ shopping.slice(20));
//console.log(shopping.substring(0,17)+shopping.substring(20));
...
console.log("- "+shopping.slice(0,5));
let shoppingitem = shopping.replace("Apfel", "Birne");
console.log("- "+shoppingitem.slice(0,5));
console.log("- "+shopping.slice(20,27));
console.log("- "+shopping.slice(29));
console.log("-".repeat(20))
*/
